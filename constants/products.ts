...
export const PRODUCTS: Product[] = [
  {
    ...
    freeGiftBundle: {
      id: "bundle-apex-jbl",
      enabled: true,
      headline: "Free Launch Bundle Included",
      giftTitle: "JBL Flip 6 Lossless Bluetooth Speaker",
      giftImage: "https://images.unsplash.com/photo-1545454675-3531b543be5d?q=80&w=800&auto=format&fit=crop",
      giftOriginalPrice: 149,
      giftDescription: "Complimentary IP67 waterproof wireless acoustic speaker with 12hr endurance.",
      promoEndDate: "August 31, 2026",
      minQuantity: 1,
      maxGiftsPerOrder: 1,
      isAutoIncluded: true,
      badgeText: "🎁 FREE $149 SPEAKER",
      wooCommerceCampaignId: "woo-campaign-launch-2026",
    },
  ...
  },
  {
    ...
    expressDelivery: true,
    freeGiftBundle: {
      id: "bundle-hyperbook-sleeve",
      enabled: true,
      headline: "Pro Workstation Gift Suite Included",
      giftTitle: "Grade 5 Titanium Leather Sleeve & 120W Fast Dock",
      giftImage: "https://images.unsplash.com/photo-1508685096489-7aacd43bd3b1?q=80&w=800&auto=format&fit=crop",
      giftOriginalPrice: 229,
      giftDescription: "Complimentary magnetic armor leather sleeve with multi-port fast charging dock.",
      promoEndDate: "September 15, 2026",
      minQuantity: 1,
      maxGiftsPerOrder: 1,
      isAutoIncluded: true,
      badgeText: "🎁 FREE $229 DOCK & SLEEVE",
      wooCommerceCampaignId: "woo-campaign-mac-2026",
    },
